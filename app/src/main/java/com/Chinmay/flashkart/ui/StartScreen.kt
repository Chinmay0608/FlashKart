...
fun StartScreen(
    ...
    LazyVerticalGrid(columns = GridCells.Adaptive(128.dp),
        ...
        item(span = {
            ...
            Column {
                Image(painter = painterResource(id = R.drawable.category_banner), contentDescription = "Category Banner",
...
fun CategoryCard(context:Context,
    ...
    Card(modifier = Modifier.clickable {
        ...
        Toast.makeText(context,"This was Card Clicked",Toast.LENGTH_SHORT).show()
